CREATE OR REPLACE Function COTAFA.ufTBL_4230_GL (
...
BEGIN
  ...
  IF SP_Kind = 'DATA' THEN
    ...
    vQuery := vQuery || '     , ufName(A.Com_ID, ''ORD_DELI.DELI_KIND'', A.Ord_No) AS deliKind ';
    vQuery := vQuery || '     , ufName(A.Com_ID, ''ORD_PDT.DELI_FINISH'', A.Ord_No) AS deliStatus ';
